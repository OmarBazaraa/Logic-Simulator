...
#define JFIF_LEN 14
  ...
  if (length >= JFIF_LEN) {
	...
	TRACEMS2(cinfo, 1, JTRC_JFIF_MINOR, b[5], b[6]);
      ...
      cinfo->X_density = (unsigned short) ((b[8] << 8) + b[9]);
      cinfo->Y_density = (unsigned short) ((b[10] << 8) + b[11]);
...
#define ADOBE_LEN 12
  ...
  if (length >= ADOBE_LEN) {
    ...
    if (b[0]==0x41 && b[1]==0x64 && b[2]==0x6F && b[3]==0x62 && b[4]==0x65) {
      ...
      version = (unsigned int) ((b[5] << 8) + b[6]);
      flags0 = (unsigned int) ((b[7] << 8) + b[8]);
      flags1 = (unsigned int) ((b[9] << 8) + b[10]);
      transform = b[11];
